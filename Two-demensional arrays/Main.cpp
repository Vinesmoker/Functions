...
void main()
{
	...
	cout << "Введите количество смещений: "; cin >> n; cout << "Смещение массива на " << n << " влево: " << endl;
	ShiftLeft(arr, rows, cols, n); Print(arr, rows, cols);
	cout << "Смещение массива на " << n << " вправо: " << endl;
	...
	cout << "Смещение массива на " << n << " влево: " << endl;
